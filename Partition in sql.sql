...
insert into orders_ranges select * from orders;

select * from orders_ranges;

select * from orders_ranges
where (order_date between'2023-05-07' and '2024-04-09');

select * from orders_ranges
where order_date in('2024-04-07','2024-01-05','2024-04-09');

select * from orders_ranges
where (order_date between'2023-05-07' and '2024-04-09')
or order_date in ('2024-02-01','2023-05-03','2024-04-05');
