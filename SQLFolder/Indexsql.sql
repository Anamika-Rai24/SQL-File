...
select * from indexing.Student_index;

create index phone_index on Student_index(phone);

select * from Student_index where phone='9000000088';

create index email_index on Student_index(email);

select * from Student_index where email='student85@gmail.com';
...
create index address_age on Student_index(age,address);
